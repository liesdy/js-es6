 ...
 */
 ...
 // 不过这只是对象中的方法对其他对象的call

 // 如果是构造函数直接call对象
 // 因为相当于构造函数中的this变成了目标对象
 // 执行构造函数的过程相当于把构造函数中的属性和方法都赋值给了目标对象
 // 但是有一点需要注意，es5中的这种过程是无法把原生的构造函数中的方法赋值给目标对象的
 // 原生的构造函数是指 Number  Object  Array这种js自带的构造函数
 // 想要继承原生构造函数的方法可以用es6的类中的extends关键字来实现